...
public:
	...
	void Draw(const Point2f& dstBottomLeft = {}, const Rectf& srcRect = {}, bool flipped = false) const;
	void Draw( const Rectf& dstRect, const Rectf& srcRect = {}, bool flipped = false) const;
